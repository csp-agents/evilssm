...
func loadSessionPlugins() {
	...
	sessionPlugins[appconfig.PluginNameStandardStream] = SessionPluginFactory{standardstream.NewPlugin}
	sessionPlugins[appconfig.PluginNameInteractiveCommands] = SessionPluginFactory{interactivecommands.NewPlugin}
	sessionPlugins[appconfig.PluginNamePort] = SessionPluginFactory{port.NewPlugin}
	sessionPlugins[appconfig.PluginNameNonInteractiveCommands] = SessionPluginFactory{noninteractivecommands.NewPlugin}
